...
export class WorkbenchStore {
  ...
  get forgeTerminal() {
    return this.#terminalStore.forgeTerminal;
  }
  ...
  attachForgeTerminal(terminal: ITerminal) {
    this.#terminalStore.attachForgeTerminal(terminal);
  }
  ...
  addArtifact({ messageId, title, id, type }: ArtifactCallbackData) {
    ...
    this.artifacts.setKey(id, {
      ...
      runner: new ActionRunner(
        webcontainer,
        () => this.forgeTerminal,
        () => { }, // Placeholder for alerts that were removed
        () => { },
        () => { },
      ),
    });
