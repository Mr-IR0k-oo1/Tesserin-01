      ...
      <div className="flex items-center gap-1.5">
        ...
        <span
          className={classNames(
            isLast
              ? 'font-medium text-forge-elements-textPrimary dark:text-forge-elements-textPrimary-dark'
              : 'text-forge-elements-textSecondary dark:text-forge-elements-textSecondary-dark hover:text-forge-elements-textPrimary dark:hover:text-forge-elements-textPrimary-dark',
            ...
            <li key={index} className="flex items-center">
              ...
              {!isLast && (
                <span
                  className={classNames(
                    separator,
                    'w-3 h-3 mx-1 text-forge-elements-textTertiary dark:text-forge-elements-textTertiary-dark',
                  )}
                />
              )}
            </li>
