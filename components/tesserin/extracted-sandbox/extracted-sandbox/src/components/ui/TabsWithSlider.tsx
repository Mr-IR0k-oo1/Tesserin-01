        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-forge-elements-background-depth-2 dark:bg-forge-elements-background-depth-3 text-forge-elements-textPrimary dark:text-forge-elements-textPrimary-dark hover:bg-forge-elements-background-depth-3 dark:hover:bg-forge-elements-background-depth-4 border border-forge-elements-borderColor dark:border-forge-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
