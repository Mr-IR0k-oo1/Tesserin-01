  ...
  return (
    <div
      ...
      className={classNames(
        'rounded-lg border border-forge-elements-borderColor bg-forge-elements-background-depth-1 text-forge-elements-textPrimary shadow-sm',
        className,
      )}
      {...props}
    />
...
const CardDescription = forwardRef<HTMLParagraphElement, React.HTMLAttributes<HTMLParagraphElement>>(
  ({ className, ...props }, ref) => {
    return <p ref={ref} className={classNames('text-sm text-forge-elements-textSecondary', className)} {...props} />;
  },
);
